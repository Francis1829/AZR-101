...
function About() {
  return (
    ...
    <div className='container mx-auto px-4 bg-[#b5913a]/15 rounded-xl'>
      <div className='w-full flex justify-center gap-10 py-16 px-16'>
          ...
          <div className='w-[40%]'>
          <div className='text-[4rem] font-[Catamaran] font-semibold tracking-wider mb-20 text-end text-[#b5913a]'>Why Work with AZR?</div>
