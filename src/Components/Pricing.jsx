...
the Services with the following rate</div>
        ...
        <div className=' first border-2 border-[#b5913a]/15 2xl:w-[500px] xl/lg:w-[300px] 2xl:h-[600px] xl/lg:h-[500px] p-8 mx-7 rounded-lg shadow-2xl flex flex-col justify-start items-center cursor-pointer bg-[#fafafa]'>
